...
export const INFRASTRUCTURE_SECTIONS: InfrastructureSection[] = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        role: "Metrics Pipeline",
        status: "active",
        kind: "worker",
        url: "https://analytics-worker.cryptolinx.workers.dev",
      ...
      },
      {
        ...
        status: "active",
        kind: "worker",
        url: "https://report-worker.cryptolinx.workers.dev",
        services: ["R2", "KV", "Service Binding"],
      },
      {
        name: "pyne-worker",
        role: "PYNE Edge Evaluate",
        status: "active",
        kind: "worker",
        url: "https://pyne-worker.cryptolinx.workers.dev",
