...
- **[hoox Gateway](workers/hoox-worker)** · **[trade-worker](workers/trade-worker)** · **[agent-worker](workers/agent-worker)** · **[telegram-worker](workers/telegram-worker)**
...
Full institutional architecture documentation (Workers for Platforms, Workflows, Logpush audit, Enterprise security) for the **closed-source commercial layer** lives at [docs/enterprise/](../enterprise/).

See root [OPEN_CORE.md](../../OPEN_CORE.md) and [OPEN_CORE_FEATURE_SPLIT.md](../../OPEN_CORE_FEATURE_SPLIT.md). This public repo only includes the open core + public design docs.
