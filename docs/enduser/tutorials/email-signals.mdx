...
`"test": true` requests exchange testnet execution (Binance/Bybit). Plaintext extraction never sets `test` — always live. See [Test Trading](/enduser/guides/test-trading).
