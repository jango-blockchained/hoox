...
// longAlertJson = '{"apiKey": "your-hoox-webhook-passkey", "exchange": "bybit", "action": "LONG", "symbol": "BTCUSDT", "quantity": 0.001, "leverage": 10, "test": true}'
...
<Tip>
  ...
  with a `401 Unauthorized` error. For exchange testnet rehearsal, add
  `"test": true` to the JSON and configure dedicated testnet secrets — see
  [Test Trading](/enduser/guides/test-trading).
</Tip>
