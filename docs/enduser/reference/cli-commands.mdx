...
The `@hoox-sh/hoox-cli` tool manages the entire monorepo development, provisioning, deployment, monitoring, and self-healing pipelines. This reference provides the complete command tree, positional arguments, optional flags, and concrete examples for all command groups.
...
See [`packages/cli/CHANGELOG.md`](https://github.com/hoox-sh/hoox-setup/blob/main/packages/cli/CHANGELOG.md) for the full release notes.
