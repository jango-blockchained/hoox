...
- **[AI Risk Manager](concepts/ai-risk-manager)** — The configurable-cron autonomous risk scanner (1–1440 min), trailing-stop mathematician, and account kill-switch.
...
- **[Test Trading](guides/test-trading)** — Sandbox orders with `"test": true`, dedicated testnet secrets, and D1/dashboard isolation.
...
Consolidated specifications and LLM context packages are available in the [GitHub repository](https://github.com/hoox-sh/hoox-setup).
