...
<ol>
  ...
  <li>
    <code>agent-worker</code> halts its cron execution loop.
  </li>
  <li>
...
Sandbox fills use position ids like `bybit-testnet-BTCUSDT-LONG`. Filter them in the Dashboard Positions **mode** control (Live only / Testnet / Live + Test). See [Test Trading](/enduser/guides/test-trading).
